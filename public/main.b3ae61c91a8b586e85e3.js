...
const Socket = __webpack_require__(2192);
...
const transports = __webpack_require__(3352);
const Emitter = __webpack_require__(8767);
const debug = __webpack_require__(4802)("engine.io-client:socket");
...
const debug = __webpack_require__(4802)("engine.io-client:polling-xhr");
...
const Transport = __webpack_require__(6496);
const parseqs = __webpack_require__(1830);
const parser = __webpack_require__(9743);
const yeast = __webpack_require__(2281);

const debug = __webpack_require__(4802)("engine.io-client:polling");
...
const debug = __webpack_require__(4802)("engine.io-client:websocket");
...
const { PACKET_TYPES_REVERSE, ERROR_PACKET } = __webpack_require__(1712);
...
const { PACKET_TYPES } = __webpack_require__(1712);
...
const encodePacket = __webpack_require__(2929);
...
const debug = __webpack_require__(3669)("socket.io-client");
/**
 * Module exports.
 */
...
const debug = __webpack_require__(3669)("socket.io-client:manager");
...
const Emitter = __webpack_require__(8767);
const on_1 = __webpack_require__(5657);
const debug = __webpack_require__(3669)("socket.io-client:socket");
/**
 * Internal events.
...
exports.url = void 0;
const parseuri = __webpack_require__(4187);
const debug = __webpack_require__(3669)("socket.io-client:url");
/**
 * URL parser.
 *
 * @param uri - url
...
const is_binary_1 = __webpack_require__(2986);
const debug = __webpack_require__(1618)("socket.io-parser");
/**
 * Protocol version.
 *
 * @public
...
module.exports = __webpack_require__(5224)(exports);
...
function setup(env) {
	...
	createDebug.enable = enable;
	createDebug.enabled = enabled;
	createDebug.humanize = __webpack_require__(8896);
	createDebug.destroy = destroy;
...
function deepEqual(object1, object2, isErrorObject) {
    ...
    if (!(0,react.isValidElement)(object1)) {
...
var isMessage = (value) => isString(value) || (0,react.isValidElement)(value);
...
function useForm({ mode = VALIDATION_MODE.onSubmit, reValidateMode = VALIDATION_MODE.onChange, resolver, context, defaultValues = {}, shouldFocusError = true, shouldUnregister = true, criteriaMode, } = {}) {
    ...
    const fieldArrayDefaultValuesRef = (0,react.useRef)({});
    const fieldArrayValuesRef = (0,react.useRef)({});
    const watchFieldsRef = (0,react.useRef)(new Set());
    const useWatchFieldsRef = (0,react.useRef)({});
    const useWatchRenderFunctionsRef = (0,react.useRef)({});
    const fieldsWithValidationRef = (0,react.useRef)({});
    const validFieldsRef = (0,react.useRef)({});
    const defaultValuesRef = (0,react.useRef)(defaultValues);
    const isUnMount = (0,react.useRef)(false);
    const isWatchAllRef = (0,react.useRef)(false);
    const handleChangeRef = (0,react.useRef)();
    const shallowFieldsStateRef = (0,react.useRef)({});
    const resetFieldArrayFunctionRef = (0,react.useRef)({});
    const contextRef = (0,react.useRef)(context);
    const resolverRef = (0,react.useRef)(resolver);
    const fieldArrayNamesRef = (0,react.useRef)(new Set());
    const modeRef = (0,react.useRef)(modeChecker(mode));
    ...
    const readFormStateRef = (0,react.useRef)({
    ...
    const formStateRef = (0,react.useRef)(formState);
    const observerRef = (0,react.useRef)();
    const { isOnBlur: isReValidateOnBlur, isOnChange: isReValidateOnChange, } = (0,react.useRef)(modeChecker(reValidateMode)).current;
    ...
    const updateFormState = (0,react.useCallback)((state = {}) => {
    ...
    const shouldRenderBaseOnError = (0,react.useCallback)((name, error, shouldRender = false, state = {}, isValid) => {
    ...
    const setFieldValue = (0,react.useCallback)((name, rawValue) => {
    ...
    const isFormDirty = (0,react.useCallback)((name, data) => {
    ...
    const updateAndGetDirtyState = (0,react.useCallback)((name, shouldRender = true) => {
        if (readFormStateRef.current.isDirty ||
    ...
    const executeValidation = (0,react.useCallback)(async (name, skipReRender) => {
        if (false) {}
        const error = (await validateField(fieldsRef, isValidateAllFieldCriteria, fieldsRef.current[name], shallowFieldsStateRef))[name];
        shouldRenderBaseOnError(name, error, skipReRender);
        return isUndefined(error);
    }, [shouldRenderBaseOnError, isValidateAllFieldCriteria]);
    const executeSchemaOrResolverValidation = (0,react.useCallback)(async (names) => {
    ...
    const trigger = (0,react.useCallback)(async (name) => {
    ...
    const setInternalValues = (0,react.useCallback)((name, value, { shouldDirty, shouldValidate }) => {
        const data = {};
        set(data, name, value);
    ...
    const setInternalValue = (0,react.useCallback)((name, value, config) => {
        !shouldUnregister &&
            !isPrimitive(value) &&
    ...
    const validateResolver = (0,react.useCallback)(async (values = {}) => {
    ...
    const removeFieldEventListener = (0,react.useCallback)((field, forceDelete) => findRemovedFieldAndRemoveListener(fieldsRef, handleChangeRef.current, field, shallowFieldsStateRef, shouldUnregister, forceDelete), [shouldUnregister]);
    const updateWatchedValue = (0,react.useCallback)((name) => {
    ...
    const removeFieldEventListenerAndRef = (0,react.useCallback)((field, forceDelete) => {
        if (field) {
    ...
    const watchInternal = (0,react.useCallback)((fieldNames, defaultValue, watchId) => {
    ...
    const handleSubmit = (0,react.useCallback)((onValid, onInvalid) => async (e) => {
    ...
    const commonProps = {
        trigger,
        setValue: (0,react.useCallback)(setValue, [setInternalValue, trigger]),
        getValues: (0,react.useCallback)(getValues, []),
        register: (0,react.useCallback)(register, [defaultValuesRef.current]),
        unregister: (0,react.useCallback)(unregister, []),
    ...
    const control = (0,react.useMemo)(() => (Object.assign({ isFormDirty,
        updateWatchedValue,
        shouldUnregister,
        updateFormState,
    ...
    return Object.assign({ watch,
        control,
        handleSubmit, reset: (0,react.useCallback)(reset, []), clearErrors: (0,react.useCallback)(clearErrors, []), setError: (0,react.useCallback)(setError, []), errors: formState.errors }, commonProps);
}
...
;// CONCATENATED MODULE: ./src/components/Input/styled.js


function _EMOTION_STRINGIFIED_CSS_ERROR__() { return "You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop)."; }

var Label = emotion_styled_base_browser_esm("label", {
  target: "e83qrkc1",
  label: "Label"
})( true ? {
  name: "mxnqzd",
  styles: "display:flex;flex-direction:column;justify-content:center;align-items:center;font-size:1rem;font-weight:600;font-family:'Lucida Sans','Lucida Sans Regular','Lucida Grande','Lucida Sans Unicode',Geneva,Verdana,sans-serif;color:#ffffff"
} : 0);
var InputF = emotion_styled_base_browser_esm("input", {
  target: "e83qrkc0",
  label: "InputF"
})( true ? {
  name: "ru40va",
  styles: "display:inline-block;width:170px;margin:0;padding:.2rem;background-color:whitesmoke;border:none;border-bottom-left-radius:10px;border-top-left-radius:10px;font-size:1rem;height:29px"
} : 0);
...
var Input = function Input(_ref) {
  var name = _ref.name,
      ...
      msg = _ref.msg,
      view_label = _ref.view_label;

  var handleClear = function handleClear(e) {
    e.target.value = '';
  };

  return /*#__PURE__*/react.createElement(react.Fragment, null, view_label && /*#__PURE__*/react.createElement(Label, {
    className: "label"
  }, name), /*#__PURE__*/react.createElement(InputF, {
    className: "input ".concat(style),
    name: name,
    type: type,
...
;// CONCATENATED MODULE: ./src/components/Button/styled.js


function styled_EMOTION_STRINGIFIED_CSS_ERROR_() { return "You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop)."; }

var Button_Form = emotion_styled_base_browser_esm("button", {
  target: "ewbwlu20",
  label: "Button_Form"
})( true ? {
  name: "myupdb",
  styles: "display:inline-block;margin-right:2px;background-color:var(--brand-color_7);color:var(--theme-title);font-size:0.8rem;padding:.2rem;font-family:'Gill Sans','Gill Sans MT',Calibri,'Trebuchet MS',sans-serif;font-weight:900;width:60px;height:36px;border:none;border-top:2px solid var(--theme-body-txt);border-left:2px solid var(--theme-body-txt);border-bottom:2px solid var(--theme-body-txt);border-top-right-radius:10px;border-bottom-right-radius:10px;letter-spacing:1px;text-transform:uppercase;&:hover{background-color:var(--brand-color_8);}"
} : 0);
...
var Button = function Button(_ref) {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(Button_Form, {
    id: id,
    name: name,
    type: type,
    className: "button ".concat(style),
    disable: disable,
    value: value
  }, value));
};
...
;// CONCATENATED MODULE: ./src/page/Home/styled.js


function Home_styled_EMOTION_STRINGIFIED_CSS_ERROR_() { return "You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop)."; }

var Div_Form = emotion_styled_base_browser_esm("div", {
  target: "e1szi3kj2",
  label: "Div_Form"
})( true ? {
  name: "wlkcds",
  styles: "background-color:var(--brand-color_4);display:flex;flex-direction:column;justify-content:center;align-items:center;width:100%;border:5px solid var(--theme-body-border);margin:10px;border-radius:10px;max-width:280px;height:200px"
} : 0);
var Span_Error = emotion_styled_base_browser_esm("span", {
  target: "e1szi3kj1",
  label: "Span_Error"
})( true ? {
  name: "7kif6k",
  styles: "display:flex;flex-direction:column;justify-content:center;align-items:center;margin:10px;font-family:var(--font-fam);font-size:var(--font-size);color:var(--brand-color_13);font-weight:700;height:100px"
} : 0);
var Div_Input = emotion_styled_base_browser_esm("div", {
  target: "e1szi3kj0",
  label: "Div_Input"
})( true ? {
  name: "1vcob1d",
...
;// CONCATENATED MODULE: ./src/asset/img/favicon.png
/* harmony default export */ const favicon = (__webpack_require__.p + "2e2d1204ad70da2e936b88743f98079d.png");
;// CONCATENATED MODULE: ./src/page/Home/Home.js
...
var Home = function Home() {
  ...
  var history = useHistory(); //Se crea un objeto para la navegacion

  var _useState = (0,react.useState)(false),
      _useState2 = slicedToArray_default()(_useState, 2),
      errorUser = _useState2[0],
      setErrorUse = _useState2[1];

  var onSubmit = function onSubmit(data) {
    var socket = wrapper();

    if (data.username.length !== 0) {
      socket.emit('new user', data.username, function (res) {
        res ? history.push("/chats/".concat(data.username)) : setErrorUse(true);
      });
    }
  };

  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(HelmetExport, null, /*#__PURE__*/react.createElement("title", null, "Home_Web_Chat"), /*#__PURE__*/react.createElement("meta", {
    name: "application-name",
    content: "home_web_chat"
    ...
    sizes: "32x32",
    type: "image/png"
  })), /*#__PURE__*/react.createElement(Div_Form, null, /*#__PURE__*/react.createElement("form", {
    onSubmit: handleSubmit(onSubmit)
  }, /*#__PURE__*/react.createElement(Div_Input, null, /*#__PURE__*/react.createElement(Input_Input, {
    name: "username",
    type: "text",
    register: register,
    validate: {
    ...
    value: "Send",
    type: "submit"
  })), /*#__PURE__*/react.createElement(Span_Error, null, ((_errors$username = errors.username) === null || _errors$username === void 0 ? void 0 : _errors$username.type) === "required" && "Your username is required", ((_errors$username2 = errors.username) === null || _errors$username2 === void 0 ? void 0 : _errors$username2.type) === "maxLength" && "Your username exceed maxLength = 100", errorUser ? /*#__PURE__*/react.createElement("p", null, "Username is Active!") : ''))));
};

/* harmony default export */ const Home_Home = (Home);
;// CONCATENATED MODULE: ./src/components/Box_Chat/styled.js


function Box_Chat_styled_EMOTION_STRINGIFIED_CSS_ERROR_() { return "You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop)."; }

var styled_Div_Form = emotion_styled_base_browser_esm("div", {
  target: "e16iat3m2",
  label: "Div_Form"
})( true ? {
  name: "fum72b",
  styles: "background-color:var(--brand-color_4);display:flex;flex-direction:column;justify-content:center;align-items:center;width:280px;border:5px solid var(--theme-body-border);margin:2px;border-radius:10px"
} : 0);
var styled_Span_Error = emotion_styled_base_browser_esm("span", {
  target: "e16iat3m1",
  label: "Span_Error"
})( true ? {
  name: "zudoeg",
  styles: "display:flex;flex-direction:column;justify-content:center;align-items:center;margin:0px;padding:0px;font-family:var(--font-fam);font-size:var(--font-size);color:var(--brand-color_13);font-weight:700;height:20px"
} : 0);
var styled_Div_Input = emotion_styled_base_browser_esm("div", {
  target: "e16iat3m0",
  label: "Div_Input"
})( true ? {
  name: "1mxy0ed",
  styles: "display:flex;justify-content:center;align-items:center;margin-top:3px"
} : 0);
;// CONCATENATED MODULE: ./src/components/Box_Chat/Box.js
...
var Box = function Box(_ref) {
  var _errors$chats, _errors$chats2;
  ...
  return /*#__PURE__*/react.createElement(styled_Div_Form, null, /*#__PURE__*/react.createElement("form", {
    onSubmit: handleSubmit(onSubmit)
  }, /*#__PURE__*/react.createElement(styled_Div_Input, null, /*#__PURE__*/react.createElement(Input_Input, {
    name: "chats",
    register: register,
    validate: {
      required: true,
    ...
    type: "submit",
    register: register
  }))), /*#__PURE__*/react.createElement(styled_Span_Error, null, ((_errors$chats = errors.chats) === null || _errors$chats === void 0 ? void 0 : _errors$chats.type) === "required" && "Message is Required", ((_errors$chats2 = errors.chats) === null || _errors$chats2 === void 0 ? void 0 : _errors$chats2.type) === "maxLength" && "Your Message Exceed maxLength = 100"));
};

/* harmony default export */ const Box_Chat_Box = (Box);
// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/toConsumableArray.js
var toConsumableArray = __webpack_require__(319);
var toConsumableArray_default = /*#__PURE__*/__webpack_require__.n(toConsumableArray);
;// CONCATENATED MODULE: ./src/components/Autor_Chat/styled.js


function Autor_Chat_styled_EMOTION_STRINGIFIED_CSS_ERROR_() { return "You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop)."; }

var Div_Path_Autor = emotion_styled_base_browser_esm("div", {
  target: "e183kyds3",
  label: "Div_Path_Autor"
})( true ? {
  name: "arj1h1",
  styles: "display:flex;justify-content:flex-end;font-family:Verdana,Geneva,Tahoma,sans-serif;font-size:0.8rem;width:100%"
} : 0);
var Div_Path_Friend = emotion_styled_base_browser_esm("div", {
  target: "e183kyds2",
  label: "Div_Path_Friend"
})( true ? {
  name: "rf40j1",
  styles: "display:flex;justify-content:flex-start;font-family:Verdana,Geneva,Tahoma,sans-serif;font-size:0.8rem;width:100%"
} : 0);
var Div_Autor = emotion_styled_base_browser_esm("div", {
  target: "e183kyds1",
  label: "Div_Autor"
})( true ? {
  name: "iuky48",
  styles: "background-color:var(--brand-color_9);width:200px;border-radius:10px;padding:3px;margin:5px"
} : 0);
var Div_Friend = emotion_styled_base_browser_esm("div", {
  target: "e183kyds0",
  label: "Div_Friend"
})( true ? {
  name: "l5hkd7",
  styles: "background-color:var(--brand-color_10);width:200px;border-radius:10px;padding:3px;margin:5px"
} : 0);
;// CONCATENATED MODULE: ./src/components/Autor_Chat/Autor.js



var Autor = function Autor(_ref) {
  var message = _ref.message,
      username = _ref.username;
  return /*#__PURE__*/react.createElement(react.Fragment, null, message.from === username && /*#__PURE__*/react.createElement(Div_Path_Autor, null, /*#__PURE__*/react.createElement(Div_Autor, null, /*#__PURE__*/react.createElement("i", null, message.from), " :", message.msg)), message.from !== username && /*#__PURE__*/react.createElement(Div_Path_Friend, null, /*#__PURE__*/react.createElement(Div_Friend, null, /*#__PURE__*/react.createElement("i", null, message.from), " :", message.msg)));
};

/* harmony default export */ const Autor_Chat_Autor = (Autor);
;// CONCATENATED MODULE: ./src/components/Message_Chat/styled.js


function Message_Chat_styled_EMOTION_STRINGIFIED_CSS_ERROR_() { return "You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop)."; }

var Div_Msg = emotion_styled_base_browser_esm("div", {
  target: "e1smxh3r0",
  label: "Div_Msg"
})( true ? {
  name: "yqr8nr",
  styles: "display:flex;flex-direction:column;align-items:center;background-color:var(--theme--contrast);width:95%;height:300px;border:5px solid var(--brand-color_4);border-radius:10px;overflow:auto"
} : 0);
;// CONCATENATED MODULE: ./src/components/Message_Chat/Message.js
...
var Message = function Message(_ref) {
  ...
  (0,react.useEffect)(function () {
    socket.on('all messages', function (listMsg) {
  ...
  (0,react.useEffect)(function () {
    socket.on('new message', function (data) {
      ...
      setMessages([].concat(toConsumableArray_default()(messages), [data]));
    });
    return function () {
      socket.emit('disconnected');
      socket.off();
  ...
  var msg = messages.map(function (item, index) {
    return /*#__PURE__*/react.createElement(Autor_Chat_Autor, {
      key: index,
      message: item,
      username: username
    });
  });
  return /*#__PURE__*/react.createElement(Div_Msg, null, msg, /*#__PURE__*/react.createElement("div", {
    ref: divRef
  }));
};

/* harmony default export */ const Message_Chat_Message = (Message);
;// CONCATENATED MODULE: ./src/components/Header_Chat/styled.js


function Header_Chat_styled_EMOTION_STRINGIFIED_CSS_ERROR_() { return "You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop)."; }


var Div_Header = emotion_styled_base_browser_esm("div", {
  target: "e1swh40e3",
  label: "Div_Header"
})( true ? {
  name: "15mvm8z",
  styles: "background-color:var(--brand-color_4);width:96%;height:50px;border:5px solid var(--theme-body-border);border-radius:10px;margin:1px"
} : 0);
var styled_Link = /*#__PURE__*/emotion_styled_base_browser_esm(Link, {
  target: "e1swh40e2",
  label: "Link"
})( true ? {
  name: "1r4aypf",
  styles: "text-decoration:none;color:var(--theme-title)"
} : 0);
var Span_left = emotion_styled_base_browser_esm("span", {
  target: "e1swh40e1",
  label: "Span_left"
})( true ? {
  name: "10phndm",
  styles: "float:left;display:flex;justify-content:center;font-family:var(--font-fam);font-size:1.2rem;color:var(--theme-title);font-weight:700;margin:5px;text-transform:capitalize"
} : 0);
var Span_right = emotion_styled_base_browser_esm("span", {
  target: "e1swh40e0",
  label: "Span_right"
})( true ? {
  name: "syaa6r",
  styles: "float:right;display:flex;justify-content:center;font-family:var(--font-fam);font-size:1.5rem;color:var(--theme-title);font-weight:700;margin:5px"
} : 0);
;// CONCATENATED MODULE: ./src/components/Header_Chat/Header.js



var Header = function Header(_ref) {
  var username = _ref.username;
  return /*#__PURE__*/react.createElement(Div_Header, null, /*#__PURE__*/react.createElement(Span_left, null, "Welcome, ", username), /*#__PURE__*/react.createElement(Span_right, null, /*#__PURE__*/react.createElement(styled_Link, {
    to: "/"
  }, "X")));
};

/* harmony default export */ const Header_Chat_Header = (Header);
;// CONCATENATED MODULE: ./src/page/Chats/styled.js


function Chats_styled_EMOTION_STRINGIFIED_CSS_ERROR_() { return "You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop)."; }

var Div_Chat = emotion_styled_base_browser_esm("div", {
  target: "eg5mtn91",
  label: "Div_Chat"
})( true ? {
  name: "1m84qxd",
  styles: "display:flex;flex-direction:column;align-items:center;max-width:280px;height:450px;border:10px double var(--theme-body-border);border-radius:20px"
} : 0);
var Div_Container = emotion_styled_base_browser_esm("div", {
  target: "eg5mtn90",
  label: "Div_Container"
})( true ? {
  name: "15ktqhd",
  styles: "display:flex;align-items:center;justify-content:center;flex-wrap:wrap"
} : 0);
;// CONCATENATED MODULE: ./src/page/Chats/Chats.js
...
var Chats = function Chats() {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(HelmetExport, null, /*#__PURE__*/react.createElement("title", null, "Web_Chat"), /*#__PURE__*/react.createElement("meta", {
    name: "application-name",
    content: "web_chat"
  }), /*#__PURE__*/react.createElement("meta", {
    name: "description",
    ...
    sizes: "32x32",
    type: "image/png"
  })), /*#__PURE__*/react.createElement(Div_Container, null, /*#__PURE__*/react.createElement(Div_Chat, null, /*#__PURE__*/react.createElement(Header_Chat_Header, {
    username: username
  }), /*#__PURE__*/react.createElement(Message_Chat_Message, {
    username: username
  }), /*#__PURE__*/react.createElement(Box_Chat_Box, {
    username: username
  }))));
};

/* harmony default export */ const Chats_Chats = (Chats);
;// CONCATENATED MODULE: ./src/page/Error/Error.js


var Error_Error = function Error() {
  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("h1", null, "Error 404"));
};

/* harmony default export */ const page_Error_Error = (Error_Error);
;// CONCATENATED MODULE: ./src/styled.js


function src_styled_EMOTION_STRINGIFIED_CSS_ERROR_() { return "You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop)."; }


var styled_Header = emotion_styled_base_browser_esm("header", {
  target: "eweqdd54",
  label: "Header"
})( true ? {
  name: "5yu65u",
  styles: "display:flex;justify-content:center;align-items:center;margin:0px;padding:0px"
} : 0);
var src_styled_Link = /*#__PURE__*/emotion_styled_base_browser_esm(Link, {
  target: "eweqdd53",
  label: "Link"
})( true ? {
  name: "1iowd02",
  styles: "display:flex;justify-content:center;align-items:center;text-decoration:none;margin:0px;padding:0px"
} : 0);
var Img = emotion_styled_base_browser_esm("img", {
  target: "eweqdd52",
  label: "Img"
})( true ? {
  name: "mvhsqv",
  styles: "witdh:100%;max-witdh:60px;max-height:60px;border-radius:50%;margin:0px 5px"
} : 0);
var H1 = emotion_styled_base_browser_esm("h1", {
  target: "eweqdd51",
  label: "H1"
})( true ? {
  name: "mu4un1",
  styles: "color:var(--theme-title)"
} : 0);
var DIV = emotion_styled_base_browser_esm("div", {
  target: "eweqdd50",
  label: "DIV"
})( true ? {
  name: "1bk0czq",
  styles: "background-color:var(--brand-color_4);border:5px solid var(--theme-body-border);border-radius:10px;margin:10px;width:100%;max-width:280px;height:80px"
} : 0);
;// CONCATENATED MODULE: ./src/asset/img/logo.png
/* harmony default export */ const logo = (__webpack_require__.p + "e806dcc317fcbe902e8b082cb042dbf6.png");
...
var App = function App() {
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(DIV, null, /*#__PURE__*/react.createElement(styled_Header, null, /*#__PURE__*/react.createElement(src_styled_Link, {
    to: "/"
  }, /*#__PURE__*/react.createElement(H1, null, "Web"), /*#__PURE__*/react.createElement(Img, {
    src: logo,
    alt: "Logo"
  }), /*#__PURE__*/react.createElement(H1, null, "Chat")))), /*#__PURE__*/react.createElement(Switch, null, /*#__PURE__*/react.createElement(Route, {
    path: "/",
    exact: true
  }, /*#__PURE__*/react.createElement(Home_Home, null)), /*#__PURE__*/react.createElement(Route, {
    path: "/chats/:username"
  }, /*#__PURE__*/react.createElement(Chats_Chats, null)), /*#__PURE__*/react.createElement(Route, {
    path: "/error"
  }, /*#__PURE__*/react.createElement(page_Error_Error, null))));
};
...
react_dom.render( /*#__PURE__*/react.createElement(BrowserRouter, null, /*#__PURE__*/react.createElement(src_App, null)), document.getElementById('root'));
})();
